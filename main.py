...
async def start_handler(_, event: Message):
	await event.reply_photo("https://telegra.ph/file/19eeb26fa2ce58765917a.jpg",
					...
					[InlineKeyboardButton('❤ Donation Link', url='https://www.telegram.dog/BOTNINJA_4')],
					[InlineKeyboardButton("Updates 𝙲𝚑𝚊𝚗𝚗𝚊𝚕", url="https://t.me/BOTNINJA_movies")],
